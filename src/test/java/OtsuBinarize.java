...
public class OtsuBinarize {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File original_f = new File("img2.jpg");
        String output_f = "img_bin";
...
//        System.out.println(Arrays.toString(histogram));
    ...
    private static int otsuTreshold(BufferedImage original) {
        ...
        int size = original.getHeight() * original.getWidth();
        ...
        int w0 = 0;
        int w1 = 0;
        System.out.println("OTSU oT=" + sum);
        float varMax = 0;
        int threshold = 0;
    ...
    private static BufferedImage binarize(BufferedImage original) {
        ...
        BufferedImage binarized = new BufferedImage(original.getWidth(), original.getHeight(), BufferedImage.TYPE_BYTE_GRAY);
